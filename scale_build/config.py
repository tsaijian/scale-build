...
BRANCH_OVERRIDES = {}
CCACHE_ENABLED = get_env_variable('CCACHE', bool, 1)
...
PARALLEL_BUILD = get_env_variable('PARALLEL_BUILDS', int, (max(cpu_count(), 8) / 2))
...
SKIP_SOURCE_REPO_VALIDATION = get_env_variable('SKIP_SOURCE_REPO_VALIDATION', bool, 1)
